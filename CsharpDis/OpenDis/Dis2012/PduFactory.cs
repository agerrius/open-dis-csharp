...
namespace OpenDis.Dis2012
{
    public static class PduFactory
    {
        ...
        public static IPdu CreatePdu(PduType type)
        {
            return type switch
            {
                PduType.Other => new OpenDis.Core.Pdu.Pdu(Enumerations.ProtocolVersion.Ieee1278_1_2012),
                ...
                PduType.ResupplyCancel => throw new NotSupportedException(),
                ...
                PduType.IntercomControl => throw new NotSupportedException(),
                PduType.AggregateState => throw new NotSupportedException(),
                PduType.IsGroupOf => throw new NotSupportedException(),
                PduType.TransferControl => throw new NotSupportedException(),
                PduType.IsPartOf => new IsPartOfPdu(),
                PduType.MinefieldState => new MinefieldStatePdu(),
                PduType.MinefieldQuery => throw new NotSupportedException(),
                PduType.MinefieldData => throw new NotSupportedException(),
                PduType.MinefieldResponseNAK => new MinefieldResponseNackPdu(),
                PduType.EnvironmentalProcess => throw new NotSupportedException(),
                PduType.GriddedData => throw new NotSupportedException(),
                ...
                PduType.SetRecordR => throw new NotSupportedException(),
